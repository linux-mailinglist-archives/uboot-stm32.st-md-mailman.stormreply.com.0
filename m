...
Received: from stm-ict-prod-mailman-01.stormreply.prv (st-md-mailman.stormreply.com [52.209.6.89])
	by mail.lfdr.de (Postfix) with ESMTPS id 48FE2101B6C
	for <lists+uboot-stm32@lfdr.de>; Tue, 19 Nov 2019 09:11:36 +0100 (CET)
Received: from ip-172-31-3-76.eu-west-1.compute.internal (localhost [127.0.0.1])
	by stm-ict-prod-mailman-01.stormreply.prv (Postfix) with ESMTP id EDEFEC36B0A
	for <lists+uboot-stm32@lfdr.de>; Tue, 19 Nov 2019 08:11:35 +0000 (UTC)
Received: from mail-yw1-f67.google.com (mail-yw1-f67.google.com
 [209.85.161.67])
 (using TLSv1.2 with cipher ECDHE-RSA-AES128-GCM-SHA256 (128/128 bits))
 (No client certificate requested)
 by stm-ict-prod-mailman-01.stormreply.prv (Postfix) with ESMTPS id D969FC36B09
 for <uboot-stm32@st-md-mailman.stormreply.com>;
 Tue, 19 Nov 2019 01:02:28 +0000 (UTC)
Received: by mail-yw1-f67.google.com with SMTP id q140so6687666ywg.0
 for <uboot-stm32@st-md-mailman.stormreply.com>;
 Mon, 18 Nov 2019 17:02:28 -0800 (PST)
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 d=1e100.net; s=20161025;
 h=x-gm-message-state:from:to:cc:subject:date:message-id:in-reply-to
 :references;
 bh=RBBdNGKaMtQ3nEEPVXqfKdI0iNGhCvJhAg6VL1TIVBc=;
 b=
X-Gm-Message-State: APjAAAXP6DwA3wduTUZ3/z7LROXDtD6Tl2tQcBu48N7FF2MF4LIH+vUl
 ZCpKHQ8frnhug9Oc7KRHtA==
X-Google-Smtp-Source: APXvYqy9jj6+61UbyRgNJjAM4QUY+OwPKvDLItcqXNHsq4nFs/8eefiGjtI7stliK9TiCAOwXXpV7g==
X-Received: by 2002:a81:9241:: with SMTP id j62mr22719726ywg.58.1574125346040; 
 Mon, 18 Nov 2019 17:02:26 -0800 (PST)
Received: from bill-the-cat.local (cpe-65-184-142-8.ec.res.rr.com.
 [65.184.142.8])
 by smtp.gmail.com with ESMTPSA id e82sm8597493ywb.87.2019.11.18.17.02.22
 (version=TLS1_3 cipher=TLS_AES_256_GCM_SHA384 bits=256/256);
 Mon, 18 Nov 2019 17:02:24 -0800 (PST)
From: Tom Rini <trini@konsulko.com>
To: u-boot@lists.denx.de
Date: Mon, 18 Nov 2019 20:02:10 -0500
Message-Id: <20191119010210.24477-5-trini@konsulko.com>
X-Mailer: git-send-email 2.17.1
In-Reply-To: <20191119010210.24477-1-trini@konsulko.com>
References: <20191119010210.24477-1-trini@konsulko.com>
X-Mailman-Approved-At: Tue, 19 Nov 2019 08:11:34 +0000
Cc: uboot-stm32@st-md-mailman.stormreply.com,
 Joe Hershberger <joe.hershberger@ni.com>, Wolfgang Denk <wd@denx.de>,
 Patrick Delaunay <patrick.delaunay@st.com>
Subject: [Uboot-stm32] [PATCHv2 5/5] env: Finish migration of common ENV
	options
...
index 7df371df4df5..2d1342fb99d7 100644
--- a/board/freescale/t104xrdb/spl.c
+++ b/board/freescale/t104xrdb/spl.c
@@ -110,17 +110,17 @@ void board_init_r(gd_t *gd, ulong dest_addr)
