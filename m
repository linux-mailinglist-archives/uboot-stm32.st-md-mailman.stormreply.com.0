...
Received: from stm-ict-prod-mailman-01.stormreply.prv (st-md-mailman.stormreply.com [52.209.6.89])
	by mail.lfdr.de (Postfix) with ESMTPS id BC812B6073
	for <lists+uboot-stm32@lfdr.de>; Wed, 18 Sep 2019 11:34:22 +0200 (CEST)
Received: from ip-172-31-3-76.eu-west-1.compute.internal (localhost [127.0.0.1])
	by stm-ict-prod-mailman-01.stormreply.prv (Postfix) with ESMTP id 872FDC36B3F
	for <lists+uboot-stm32@lfdr.de>; Wed, 18 Sep 2019 09:34:22 +0000 (UTC)
Received: from mx07-00178001.pphosted.com (mx08-00178001.pphosted.com
 [91.207.212.93])
 (using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
 (No client certificate requested)
 by stm-ict-prod-mailman-01.stormreply.prv (Postfix) with ESMTPS id 2E0A6C35E05
 for <uboot-stm32@st-md-mailman.stormreply.com>;
 Wed, 18 Sep 2019 09:30:24 +0000 (UTC)
Received: from pps.filterd (m0046660.ppops.net [127.0.0.1])
 by mx08-00178001.pphosted.com (8.16.0.42/8.16.0.42) with SMTP id
 x8I96UfO019537; Wed, 18 Sep 2019 11:30:07 +0200
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=st.com;
 h=from : to : cc : subject
 : date : message-id : in-reply-to : references : mime-version :
 content-type; s=STMicroelectronics;
 bh=wVwEOIO0oLJDUY30MyNQb5e5eUBOAtqFdbnKUzv2RhU=;
 b= 8w== 
Received: from beta.dmz-ap.st.com (beta.dmz-ap.st.com [138.198.100.35])
 by mx08-00178001.pphosted.com with ESMTP id 2v37hqu72e-1
 (version=TLSv1 cipher=ECDHE-RSA-AES256-SHA bits=256 verify=NOT);
 Wed, 18 Sep 2019 11:30:05 +0200
Received: from euls16034.sgp.st.com (euls16034.sgp.st.com [10.75.44.20])
 by beta.dmz-ap.st.com (STMicroelectronics) with ESMTP id 847AB54;
 Wed, 18 Sep 2019 09:30:00 +0000 (GMT)
Received: from Webmail-eu.st.com (Safex1hubcas21.st.com [10.75.90.44])
 by euls16034.sgp.st.com (STMicroelectronics) with ESMTP id 2E6502BB878;
 Wed, 18 Sep 2019 11:30:00 +0200 (CEST)
Received: from SAFEX1HUBCAS24.st.com (10.75.90.95) by SAFEX1HUBCAS21.st.com
 (10.75.90.44) with Microsoft SMTP Server (TLS) id 14.3.439.0; Wed, 18 Sep
 2019 11:30:00 +0200
Received: from localhost (10.201.21.107) by webmail-ga.st.com (10.75.90.48)
 with Microsoft SMTP Server (TLS) id 14.3.439.0; Wed, 18 Sep 2019 11:29:59
 +0200
From: Patrick Delaunay <patrick.delaunay@st.com>
To: <u-boot@lists.denx.de>
Date: Wed, 18 Sep 2019 11:29:20 +0200
Message-ID: <20190918092920.21435-4-patrick.delaunay@st.com>
...
X-Mailman-Approved-At: Wed, 18 Sep 2019 09:34:21 +0000
...
Subject: [Uboot-stm32] [PATCH v3 3/3] env: Add CONFIG_ENV_FULL_SUPPORT
...
(CONFIG_SPL_ENV_SUPPORT / CONFIG_TPL_ENV_SUPPORT);
...
ENV_IS_SOMEWHERE macro, which tests if the environment is somewhere
in device or in file system.
...
- Update commit message after Lukasz Majewki review
 ...
 584 files changed, 503 insertions(+), 189 deletions(-)
...
index 74db2f38cc..d35871bfc6 100644
--- a/env/Kconfig
+++ b/env/Kconfig
@@ -1,5 +1,12 @@
 menu "Environment"
...
@@ -549,7 +556,7 @@ config ENV_VARS_UBOOT_RUNTIME_CONFIG
...
@@ -606,7 +613,7 @@ config SPL_ENV_IS_IN_FLASH
