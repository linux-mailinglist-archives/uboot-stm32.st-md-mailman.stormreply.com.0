...
Received: from stm-ict-prod-mailman-01.stormreply.prv (st-md-mailman.stormreply.com [52.209.6.89])
	by mail.lfdr.de (Postfix) with ESMTPS id 1838CAD1A91
	for <lists+uboot-stm32@lfdr.de>; Mon,  9 Jun 2025 11:29:42 +0200 (CEST)
Received: from ip-172-31-3-47.eu-west-1.compute.internal (localhost [127.0.0.1])
	by stm-ict-prod-mailman-01.stormreply.prv (Postfix) with ESMTP id D2772C3F93A;
	Mon,  9 Jun 2025 09:29:41 +0000 (UTC)
Received: from mx.denx.de (mx.denx.de [89.58.32.78])
 (using TLSv1.2 with cipher ADH-AES256-GCM-SHA384 (256/256 bits))
 (No client certificate requested)
 by stm-ict-prod-mailman-01.stormreply.prv (Postfix) with ESMTPS id 787B8C3F939
 for <uboot-stm32@st-md-mailman.stormreply.com>;
 Mon,  9 Jun 2025 09:29:40 +0000 (UTC)
Received: from [127.0.0.1] (localhost [127.0.0.1]) by localhost (Mailerdaemon)
 with ESMTPSA id 8BD4A10397298; 
 Mon,  9 Jun 2025 11:29:35 +0200 (CEST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=denx.de; s=mx-20241105;
 t=1749461378; h=from:subject:date:message-id:to:cc:mime-version:content-type:
 in-reply-to:references; bh=S1po6MPhmwEQ4ZTPz8wgf4mb/OJo6VWM9nZRI8GkTbc=;
 b=
Date: Mon, 9 Jun 2025 11:29:34 +0200
From: Lukasz Majewski <lukma@denx.de>
To: Patrice CHOTARD <patrice.chotard@foss.st.com>
Message-ID: <20250609112934.4c32c56d@wsk>
...
Content-Type: multipart/mixed; boundary="===============7851684982087086482=="
Errors-To: uboot-stm32-bounces@st-md-mailman.stormreply.com
Sender: "Uboot-stm32" <uboot-stm32-bounces@st-md-mailman.stormreply.com>

--===============7851684982087086482==
Content-Type: multipart/signed; boundary="Sig_/=VQzhuqZA=qUMPRj=YVPx73";
 protocol="application/pgp-signature"; micalg=pgp-sha512

--Sig_/=VQzhuqZA=qUMPRj=YVPx73
...
> > Hi Patrice,
> >  =20
> >> On 6/7/25 11:37, Dario Binacchi wrote: =20
...
> >>> +CONFIG_DISTRO_DEFAULTS=3Dy =20
> >=20
> > I'm just wondering if there is any plan to move forward to use the
> > new approach?
> >=20
> > As fair as I remember this is the "deprecated" option... =20
>=20
> Hi Lukasz
>=20
...

=xkth
-----END PGP SIGNATURE-----
