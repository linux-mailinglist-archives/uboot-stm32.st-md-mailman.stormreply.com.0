...
Received: from stm-ict-prod-mailman-01.stormreply.prv (st-md-mailman.stormreply.com [52.209.6.89])
	by mail.lfdr.de (Postfix) with ESMTPS id 50EB45FD66D
	for <lists+uboot-stm32@lfdr.de>; Thu, 13 Oct 2022 10:47:02 +0200 (CEST)
Received: from ip-172-31-3-47.eu-west-1.compute.internal (localhost [127.0.0.1])
	by stm-ict-prod-mailman-01.stormreply.prv (Postfix) with ESMTP id EE401C640FE;
	Thu, 13 Oct 2022 08:47:01 +0000 (UTC)
Received: from mail-qv1-f42.google.com (mail-qv1-f42.google.com
 [209.85.219.42])
 (using TLSv1.2 with cipher ECDHE-RSA-AES128-GCM-SHA256 (128/128 bits))
 (No client certificate requested)
 by stm-ict-prod-mailman-01.stormreply.prv (Postfix) with ESMTPS id C9B94C0D2BF
 for <uboot-stm32@st-md-mailman.stormreply.com>;
 Wed, 12 Oct 2022 17:05:33 +0000 (UTC)
Received: by mail-qv1-f42.google.com with SMTP id mx8so11275166qvb.8
 for <uboot-stm32@st-md-mailman.stormreply.com>;
 Wed, 12 Oct 2022 10:05:33 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=gmail.com; s=20210112;
 h=content-transfer-encoding:in-reply-to:content-language:references
 :cc:to:subject:from:user-agent:mime-version:date:message-id:from:to
 :cc:subject:date:message-id:reply-to;
 bh=QLJkpoF4zUlsNHRNAy3aC3gqCFKYrqR2EyaB4A5UGwo=;
 b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 ...
 bh=QLJkpoF4zUlsNHRNAy3aC3gqCFKYrqR2EyaB4A5UGwo=;
 b=
X-Gm-Message-State: ACrzQf2IybA6U/Gm9KrTTq6cKGmJ7UwnoLLtH3h2zL+9e1xJxQbCxK6L
 zsowptckU0iSLQ3lhCUqsSo=
X-Google-Smtp-Source: AMsMyM5SL9/LoRK25YnkW6VMzuvn3jiITgLhUWHWPpr5bqPMvLmidJlRXVmEeIKYg6OYNEDOn1Ywng==
X-Received: by 2002:a05:6214:5195:b0:4b1:8425:6894 with SMTP id
 kl21-20020a056214519500b004b184256894mr23583273qvb.14.1665594331754; 
 Wed, 12 Oct 2022 10:05:31 -0700 (PDT)
Received: from [192.168.1.201] (pool-173-73-95-180.washdc.fios.verizon.net.
 [173.73.95.180]) by smtp.gmail.com with ESMTPSA id
 y11-20020ac8128b000000b0039a275607c3sm6926022qti.55.2022.10.12.10.05.30
 (version=TLS1_3 cipher=TLS_AES_128_GCM_SHA256 bits=128/128);
 Wed, 12 Oct 2022 10:05:31 -0700 (PDT)
Message-ID: <9edbd7a3-c06b-7f72-2546-7287ee3f244b@gmail.com>
Date: Wed, 12 Oct 2022 13:05:30 -0400
MIME-Version: 1.0
...
X-Mailman-Approved-At: Thu, 13 Oct 2022 08:47:00 +0000
...
and then you can remove the above implementations
...
Why do you need your own refcounting, just for gates?
...
If you are just going to branch on enable, then you can move the
implementation to the enable/disable functions directly.
...
Do you need to use an & here? Actually, I thought you'd need it for the structs, but not the functions (the opposite of what you have). Learn something new...
