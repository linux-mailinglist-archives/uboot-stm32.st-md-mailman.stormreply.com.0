...
Received: from stm-ict-prod-mailman-01.stormreply.prv (st-md-mailman.stormreply.com [52.209.6.89])
	by mail.lfdr.de (Postfix) with ESMTPS id EF8951089D7
	for <lists+uboot-stm32@lfdr.de>; Mon, 25 Nov 2019 09:13:01 +0100 (CET)
Received: from ip-172-31-3-76.eu-west-1.compute.internal (localhost [127.0.0.1])
	by stm-ict-prod-mailman-01.stormreply.prv (Postfix) with ESMTP id A3DF3C36B0A
	for <lists+uboot-stm32@lfdr.de>; Mon, 25 Nov 2019 08:13:01 +0000 (UTC)
Received: from mx07-00178001.pphosted.com (mx07-00178001.pphosted.com
 [62.209.51.94])
 (using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
 (No client certificate requested)
 by stm-ict-prod-mailman-01.stormreply.prv (Postfix) with ESMTPS id CC106C36B09
 for <uboot-stm32@st-md-mailman.stormreply.com>;
 Mon, 25 Nov 2019 08:07:59 +0000 (UTC)
Received: from pps.filterd (m0046037.ppops.net [127.0.0.1])
 by mx07-00178001.pphosted.com (8.16.0.42/8.16.0.42) with SMTP id
 xAP81t9a002615; Mon, 25 Nov 2019 09:07:48 +0100
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=st.com;
 h=from : to : cc : subject
 : date : message-id : in-reply-to : references : mime-version :
 content-type; s=STMicroelectronics;
 bh=5fYRKAmb8q0WRZwLxtPnscKAYAGchx0yby5sakdlzEE=;
 b= lQ== 
Received: from beta.dmz-eu.st.com (beta.dmz-eu.st.com [164.129.1.35])
 by mx07-00178001.pphosted.com with ESMTP id 2weudvyus7-1
 (version=TLSv1.2 cipher=ECDHE-RSA-AES256-GCM-SHA384 bits=256 verify=NOT);
 Mon, 25 Nov 2019 09:07:48 +0100
Received: from euls16034.sgp.st.com (euls16034.sgp.st.com [10.75.44.20])
 by beta.dmz-eu.st.com (STMicroelectronics) with ESMTP id A909110002A;
 Mon, 25 Nov 2019 09:07:47 +0100 (CET)
Received: from Webmail-eu.st.com (sfhdag6node3.st.com [10.75.127.18])
 by euls16034.sgp.st.com (STMicroelectronics) with ESMTP id 994492AC062;
 Mon, 25 Nov 2019 09:07:47 +0100 (CET)
Received: from localhost (10.75.127.50) by SFHDAG6NODE3.st.com (10.75.127.18)
 with Microsoft SMTP Server (TLS) id 15.0.1473.3;
 Mon, 25 Nov 2019 09:07:46 +0100
From: Patrice Chotard <patrice.chotard@st.com>
To: <u-boot@lists.denx.de>
Date: Mon, 25 Nov 2019 09:07:37 +0100
Message-ID: <20191125080741.2215-3-patrice.chotard@st.com>
...
X-Mailman-Approved-At: Mon, 25 Nov 2019 08:12:59 +0000
Cc: Bin Meng <bmeng.cn@gmail.com>, Joe Hershberger <joe.hershberger@ni.com>,
 Heinrich Schuchardt <xypron.glpk@gmx.de>, Simon Glass <sjg@chromium.org>,
 Anup Patel <Anup.Patel@wdc.com>, Patrice CHOTARD <patrice.chotard@st.com>,
 Patrick DELAUNAY <patrick.delaunay@st.com>,
 =?UTF-8?q?Marek=20Beh=C3=BAn?= <marek.behun@nic.cz>,
 AKASHI Takahiro <takahiro.akashi@linaro.org>, Michael Walle <michael@walle.cc>,
 Faiz Abbas <faiz_abbas@ti.com>,
 U-Boot STM32 <uboot-stm32@st-md-mailman.stormreply.com>,
 Ismael Luceno Cortes <ismael.luceno@silicon-gears.com>,
 Anatolij Gustschin <agust@denx.de>
Subject: [Uboot-stm32] [PATCH v3 2/6] cmd: Prepare sysboot command
	independence
...
---
 ...
 cmd/Makefile    |    2 +-
 cmd/pxe.c       | 1478 +----------------------------------------------
 cmd/pxe_utils.c | 1414 +++++++++++++++++++++++++++++++++++++++++++++
 cmd/pxe_utils.h |   90 +++
 4 files changed, 1507 insertions(+), 1477 deletions(-)
 create mode 100644 cmd/pxe_utils.c
 create mode 100644 cmd/pxe_utils.h

diff --git a/cmd/Makefile b/cmd/Makefile
index 2d723ea0f0..723b461e0d 100644
--- a/cmd/Makefile
+++ b/cmd/Makefile
...
index 2665c4f88d..5fe7d45b3d 100644
--- a/cmd/pxe.c
+++ b/cmd/pxe.c
@@ -6,23 +6,11 @@
...
@@ -35,85 +23,6 @@ const char *pxe_default_paths[] = {
 	NULL
 };
...
@@ -169,176 +78,8 @@ static int do_get_any(cmd_tbl_t *cmdtp, const char *file_path, char *file_addr)
 	return -ENOENT;
 }
...
@@ -400,1222 +141,7 @@ do_pxe_get(cmd_tbl_t *cmdtp, int flag, int argc, char * const argv[])
