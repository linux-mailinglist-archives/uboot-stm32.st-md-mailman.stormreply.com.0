...
Received: from stm-ict-prod-mailman-01.stormreply.prv (st-md-mailman.stormreply.com [52.209.6.89])
	by mail.lfdr.de (Postfix) with ESMTPS id 4D28F1FFE7
	for <lists+uboot-stm32@lfdr.de>; Thu, 16 May 2019 09:00:16 +0200 (CEST)
Received: from ip-172-31-3-76.eu-west-1.compute.internal (localhost [127.0.0.1])
	by stm-ict-prod-mailman-01.stormreply.prv (Postfix) with ESMTP id F07AFC35E06
	for <lists+uboot-stm32@lfdr.de>; Thu, 16 May 2019 07:00:15 +0000 (UTC)
Received: from mx07-00178001.pphosted.com (mx08-00178001.pphosted.com
 [91.207.212.93])
 (using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
 (No client certificate requested)
 by stm-ict-prod-mailman-01.stormreply.prv (Postfix) with ESMTPS id A112FC5661B
 for <uboot-stm32@st-md-mailman.stormreply.com>;
 Wed, 15 May 2019 16:28:43 +0000 (UTC)
Received: from pps.filterd (m0046660.ppops.net [127.0.0.1])
 by mx08-00178001.pphosted.com (8.16.0.27/8.16.0.27) with SMTP id
 x4FGCn5Y014486; Wed, 15 May 2019 18:19:40 +0200
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=st.com;
 h=from : to : cc : subject
 : date : message-id : references : in-reply-to : content-type :
 content-transfer-encoding : mime-version; s=STMicroelectronics;
 bh=mtQ31ayZiUwHEJ3jWZuyGEBxnZNDiEdNIzzvRfiOzZc=;
 b= iw== 
Received: from beta.dmz-eu.st.com (beta.dmz-eu.st.com [164.129.1.35])
 by mx08-00178001.pphosted.com with ESMTP id 2sek5akv5r-1
 (version=TLSv1 cipher=ECDHE-RSA-AES256-SHA bits=256 verify=NOT);
 Wed, 15 May 2019 18:19:40 +0200
Received: from zeta.dmz-eu.st.com (zeta.dmz-eu.st.com [164.129.230.9])
 by beta.dmz-eu.st.com (STMicroelectronics) with ESMTP id 95E3A34;
 Wed, 15 May 2019 16:19:35 +0000 (GMT)
Received: from Webmail-eu.st.com (sfhdag6node2.st.com [10.75.127.17])
 by zeta.dmz-eu.st.com (STMicroelectronics) with ESMTP id BA91D2B34;
 Wed, 15 May 2019 16:19:34 +0000 (GMT)
Received: from SFHDAG6NODE3.st.com (10.75.127.18) by SFHDAG6NODE2.st.com
 (10.75.127.17) with Microsoft SMTP Server (TLS) id 15.0.1347.2; Wed, 15 May
 2019 18:19:34 +0200
Received: from SFHDAG6NODE3.st.com ([fe80::d04:5337:ab17:b6f6]) by
 SFHDAG6NODE3.st.com ([fe80::d04:5337:ab17:b6f6%20]) with mapi id
 15.00.1347.000; Wed, 15 May 2019 18:19:34 +0200
From: Patrick DELAUNAY <patrick.delaunay@st.com>
To: Simon Goldschmidt <simon.k.r.goldschmidt@gmail.com>, Tom Rini
 <trini@konsulko.com>, "u-boot@lists.denx.de" <u-boot@lists.denx.de>
Thread-Topic: [PATCH] spl: kconfig: separate sysreset and firmware drivers
 from misc
Thread-Index: AQHVArSIRH+KPuWt3E+4wn2kcMbGaqZsST1g
Date: Wed, 15 May 2019 16:19:33 +0000
Message-ID: <38fbbbb86a434890951f03af3cfbb467@SFHDAG6NODE3.st.com>
...
X-Mailman-Approved-At: Thu, 16 May 2019 07:00:15 +0000
Cc: Peng Fan <peng.fan@nxp.com>, Christophe
 KERELLO <christophe.kerello@st.com>, Vignesh R <vigneshr@ti.com>,
 ...
 Fabio Estevam <festevam@gmail.com>, Ruchika
 Gupta <ruchika.gupta@nxp.com>, Qiang Zhao <qiang.zhao@nxp.com>,
 Marek Vasut <marex@denx.de>, Tien Fong
 Chee <tien.fong.chee@intel.com>, Ryder Lee <ryder.lee@mediatek.com>,
 ...
 York Sun <york.sun@nxp.com>, Siva Durga Prasad
 Paladugu <siva.durga.paladugu@xilinx.com>,
 ...
 Mario Six <mario.six@gdsys.cc>, Lukasz Majewski <lukma@denx.de>, Eugen
...
>  	select ROCKCHIP_BROM_HELPER
>  	help
> diff --git a/arch/arm/mach-rockchip/rk3288/Kconfig b/arch/arm/mach-
> rockchip/rk3288/Kconfig
...
> diff --git a/configs/B4860QDS_NAND_defconfig
...
> diff --git a/configs/C29XPCIE_NAND_defconfig
...
> diff --git a/configs/P1010RDB-PA_36BIT_NAND_defconfig b/configs/P1010RDB-
> PA_36BIT_NAND_defconfig
...
> diff --git a/configs/P1010RDB-PA_NAND_defconfig b/configs/P1010RDB-
> PA_NAND_defconfig
...
>  CONFIG_TPL_I2C_SUPPORT=y
>  CONFIG_TPL_MPC8XXX_INIT_DDR_SUPPORT=y
> diff --git a/configs/P1010RDB-PA_SDCARD_defconfig b/configs/P1010RDB-
> PA_SDCARD_defconfig
...
>  CONFIG_MPC85xx=y
>  CONFIG_TARGET_P1010RDB_PA=y
> diff --git a/configs/P1010RDB-PA_SPIFLASH_defconfig b/configs/P1010RDB-
> PA_SPIFLASH_defconfig
...
>  CONFIG_SPL_SPI_FLASH_SUPPORT=y
>  CONFIG_SPL_SPI_SUPPORT=y
> diff --git a/configs/P1010RDB-PB_36BIT_NAND_defconfig b/configs/P1010RDB-
> PB_36BIT_NAND_defconfig
...
>  CONFIG_SPL_SPI_FLASH_SUPPORT=y
>  CONFIG_SPL_SPI_SUPPORT=y
> diff --git a/configs/P1010RDB-PB_NAND_defconfig b/configs/P1010RDB-
> PB_NAND_defconfig
...
>  CONFIG_TPL_I2C_SUPPORT=y
>  CONFIG_TPL_MPC8XXX_INIT_DDR_SUPPORT=y
> diff --git a/configs/P1010RDB-PB_SDCARD_defconfig b/configs/P1010RDB-
> PB_SDCARD_defconfig
...
>  CONFIG_MPC85xx=y
>  CONFIG_TARGET_P1010RDB_PB=y
> diff --git a/configs/P1010RDB-PB_SPIFLASH_defconfig b/configs/P1010RDB-
> PB_SPIFLASH_defconfig
...
>  CONFIG_SPL_SPI_FLASH_SUPPORT=y
>  CONFIG_SPL_SPI_SUPPORT=y
> diff --git a/configs/T1024QDS_NAND_defconfig
...
> diff --git a/configs/T1024QDS_SDCARD_defconfig
...
>  CONFIG_SPL_SPI_FLASH_SUPPORT=y
>  CONFIG_SPL_SPI_SUPPORT=y
> diff --git a/configs/T1024RDB_NAND_defconfig
...
>  CONFIG_SPL_SPI_FLASH_SUPPORT=y
>  CONFIG_SPL_SPI_SUPPORT=y
> diff --git a/configs/T1040RDB_NAND_defconfig
...
> diff --git a/configs/T1040RDB_SDCARD_defconfig
...
>  CONFIG_SPL_SPI_FLASH_SUPPORT=y
>  CONFIG_SPL_SPI_SUPPORT=y
> diff --git a/configs/T2081QDS_NAND_defconfig
...
>  CONFIG_SPL_SPI_FLASH_SUPPORT=y
>  CONFIG_SPL_SPI_SUPPORT=y
> diff --git a/configs/T4160QDS_NAND_defconfig
...
> diff --git a/configs/T4160QDS_SDCARD_defconfig
...
>  CONFIG_MPC85xx=y
>  CONFIG_TARGET_T4160QDS=y
> diff --git a/configs/T4240QDS_NAND_defconfig
...
> diff --git a/configs/T4240QDS_SDCARD_defconfig
...
>  #define CONFIG_SPL_BOOTROM_SAVE		(CONFIG_SPL_STACK +
> 4)
>  #define CONFIG_SPL_DRIVERS_MISC_SUPPORT
> +#define CONFIG_SPL_DRIVERS_FIRMWARE_SUPPORT
> +#define CONFIG_SPL_SYSRESET_SUPPORT
