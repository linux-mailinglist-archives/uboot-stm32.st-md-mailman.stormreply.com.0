...
Received: from stm-ict-prod-mailman-01.stormreply.prv (st-md-mailman.stormreply.com [52.209.6.89])
	by mail.lfdr.de (Postfix) with ESMTPS id A8C2299287D
	for <lists+uboot-stm32@lfdr.de>; Mon,  7 Oct 2024 11:45:45 +0200 (CEST)
Received: from ip-172-31-3-47.eu-west-1.compute.internal (localhost [127.0.0.1])
	by stm-ict-prod-mailman-01.stormreply.prv (Postfix) with ESMTP id 7463FC78F61;
	Mon,  7 Oct 2024 09:45:45 +0000 (UTC)
Received: from phobos.denx.de (phobos.denx.de [85.214.62.61])
 (using TLSv1.2 with cipher ECDHE-RSA-AES128-GCM-SHA256 (128/128 bits))
 (No client certificate requested)
 by stm-ict-prod-mailman-01.stormreply.prv (Postfix) with ESMTPS id 58AE4C7802C
...
Received: from tr.lan (ip-86-49-120-218.bb.vodafone.cz [86.49.120.218])
 ...
 by phobos.denx.de (Postfix) with ESMTPSA id E38FC88DD0;
 Sat,  5 Oct 2024 03:17:05 +0200 (CEST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=denx.de;
 s=phobos-20191101; t=1728091026;
 bh=SoIS+LfoU8WpWMYjL0PXxwrj9TNBKrk6FBAeUNbPbYM=;
 h=From:To:Cc:Subject:Date:In-Reply-To:References:From;
 b=
From: Marek Vasut <marex@denx.de>
To: u-boot@lists.denx.de
Date: Sat,  5 Oct 2024 03:15:49 +0200
Message-ID: <20241005011647.436456-2-marex@denx.de>
...
X-Mailman-Approved-At: Mon, 07 Oct 2024 09:45:44 +0000
...
Subject: [Uboot-stm32] [PATCH v2 2/3] ARM: dts: stm32: Switch to using
...
index d46f0bda1a8..46452d92345 100644
--- a/arch/arm/dts/Makefile
+++ b/arch/arm/dts/Makefile
@@ -1148,7 +1148,6 @@ dtb-$(CONFIG_ASPEED_AST2600) += \
...
@@ -1164,13 +1163,7 @@ dtb-$(CONFIG_STM32MP15X) += \
...
index fb3d86deb64..1480f3013e0 100644
--- a/configs/stm32mp13_dhcor_defconfig
+++ b/configs/stm32mp13_dhcor_defconfig
@@ -6,7 +6,7 @@ CONFIG_CUSTOM_SYS_INIT_SP_ADDR=0xc0400000
